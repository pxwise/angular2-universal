...
var NodeTemplateParser = (function () {
    function NodeTemplateParser(_exprParser, _schemaRegistry, _htmlParser, _console, transforms) {
    ...
    NodeTemplateParser.prototype.parse = function (component, template, directives, pipes, templateUrl) {
    ...
    NodeTemplateParser.prototype.tryParse = function (component, template, directives, pipes, templateUrl) {
    ...
    /** @internal */
    NodeTemplateParser.prototype._assertNoReferenceDuplicationOnTemplate = function (result, errors) {
        ...
        result.filter(function (element) { return !!element.references; })
            ...
            if (existingReferences.indexOf(name) < 0) {
                ...
                var error = new template_parser_1.TemplateParseError("Reference \"#" + name + "\" is defined several times", reference.sourceSpan, parse_util_1.ParseErrorLevel.FATAL);
                errors.push(error);
            }
        }); });
    };
    NodeTemplateParser = __decorate([
        core_1.Injectable(),
...
exports.NodeTemplateParser = NodeTemplateParser;
var TemplateParseVisitor = (function () {
    ...
    TemplateParseVisitor.prototype._parseInterpolation = function (value, sourceSpan) {
        ...
        try {
            ...
            if (lang_1.isPresent(ast) &&
                ...
                throw new exceptions_1.BaseException("Only support at most " + MAX_INTERPOLATION_VALUES + " interpolation values!");
            }
            return ast;
        }
        catch (e) {
    ...
    TemplateParseVisitor.prototype._parseAnimation = function (name, expression, sourceSpan, targetMatchableAttrs, targetAnimationProps) {
        ...
        targetAnimationProps.push(new template_ast_1.BoundElementPropertyAst(name, template_ast_1.PropertyBindingType.Animation, SecurityContext.NONE, ast, null, sourceSpan));
    };
...
//# sourceMappingURL=node_template_parser-rc4.js.map